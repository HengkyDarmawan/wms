...
class RuleSimulationTest extends TenantTestCase
{
    ...
    public function tc_apr_17_aturan_divalidasi_dan_dinonaktifkan_bukan_dihapus(): void
    {
        ...
        // Semua jenis Katalog sudah tersambung (PO sejak Purchasing inti); jenis di luar katalog tetap ditolak.
        $this->gagal(fn () => $save->handle(null, ['document_type' => 'sales_order'] + $data, [$this->lapisUser($kepala)]), 'BR-GEN-10');
