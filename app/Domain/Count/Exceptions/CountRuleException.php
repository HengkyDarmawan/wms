...
namespace App\Domain\Count\Exceptions;

use RuntimeException;

/**
 * Pelanggaran aturan opname (BR-OPN, BR-STK, BR-GEN). Kode aturannya ikut
 * dibawa supaya layar bisa menyebutnya.
 */
class CountRuleException extends RuntimeException
{
