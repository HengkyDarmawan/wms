...
namespace App\Domain\Count\Livewire\Concerns;
...
/**
 * Menerjemahkan penolakan aturan opname (dan buku besar) menjadi pesan di
 * layar, dengan kode aturannya.
 */
trait HandlesCountRules
{
    ...
    protected function jalankan(callable $aksi, string $formProperty = 'form'): bool
    {
        ...
        try {
            ...
            return true;
        } catch (CountRuleException|AdjustmentRuleException $e) {
