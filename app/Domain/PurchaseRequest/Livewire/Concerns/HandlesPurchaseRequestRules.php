...
namespace App\Domain\PurchaseRequest\Livewire\Concerns;
...
/**
 * Menerjemahkan penolakan aturan Purchase Request (dan buku besar serta mesin
 * approval) menjadi pesan di layar, dengan kode aturannya.
 */
trait HandlesPurchaseRequestRules
{
