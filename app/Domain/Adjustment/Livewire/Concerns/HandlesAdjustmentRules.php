...
namespace App\Domain\Adjustment\Livewire\Concerns;
...
/**
 * Menerjemahkan penolakan aturan penyesuaian stok (dan buku besar) menjadi pesan di
 * layar, dengan kode aturannya.
 */
trait HandlesAdjustmentRules
{
