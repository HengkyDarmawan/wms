...
namespace App\Domain\Conversion\Livewire\Concerns;
...
/**
 * Menerjemahkan penolakan aturan konversi (dan buku besar serta mesin
 * approval) menjadi pesan di layar, dengan kode aturannya.
 */
trait HandlesConversionRules
{
    ...
    protected function jalankan(callable $aksi, string $formProperty = 'form'): bool
    {
        ...
        try {
            ...
            return true;
        } catch (ConversionRuleException $e) {
