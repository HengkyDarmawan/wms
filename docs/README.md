...
├── prompts/                               ← paket prompt Part 6 per modul, plus prompt audit lama dan serah terima 00-lanjutkan-di-kantor.md (rumah → kantor, aktif) / 00-lanjutkan-di-rumah.md (arsip)
