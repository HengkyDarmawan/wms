...
Verifikasi (XAMPP3 rumah): setelah 2a **621 uji hijau / 6.797 asersi**, setelah 2b **624 / 6.848**, setelah 2c **625 / 6.868**, setelah 2d+2e **630 / 7.090**; `_verify.py` OK; `ui-check` 0 error console.
