...
dict(key="master", title="Master data (tenant)", file="08a",
     ...
     entities=[
        ...
        E("projects", "Proyek", [("id","bigint","PK",""),("code","varchar(30)","UK",""),("name","varchar(150)","",""),("client_id","bigint","FK","null = Proyek Internal"),("is_internal","bool","","A-06"),("status","enum","","project_status (A-40)"),("address","text","",""),("lat","decimal(10,7)","",""),("lng","decimal(10,7)","",""),("start_date","date","",""),("target_end_date","date","",""),("pic_user_id","bigint","FK",""),("closed_at","datetime","",""),("close_reason","varchar(255)","","")]),
        E("vendors", "Vendor", [("id","bigint","PK",""),("code","varchar(30)","UK",""),("name","varchar(150)","",""),("tax_id","varchar(30)","",""),("contact_name","varchar(100)","",""),("phone","varchar(20)","",""),("email","varchar(150)","",""),("address","text","",""),("payment_terms","varchar(60)","","teks, tanpa nilai"),("vendor_type","enum","","company|shop|online_marketplace|individual (A-52)"),("status","enum","","vendor_status: active|provisional|inactive (A-53)"),("is_active","bool","","")], "Dimiliki WMS sampai Purchasing aktif"),
        E("item_vendors", "Vendor tetap per item", [("id","bigint","PK",""),("item_id","bigint","FK",""),("vendor_id","bigint","FK",""),("priority","int","","1 = utama"),("is_preferred","bool","",""),("notes","varchar(255)","","")], "UK(item_id, vendor_id); tanpa harga (A-52)"),
        E("project_material_plans", "Rencana kebutuhan material (F2)", [("id","bigint","PK",""),("project_id","bigint","FK",""),("item_id","bigint","FK",""),("version","int","",""),("planned_qty_base","decimal(18,4)","",""),("import_batch_id","bigint","FK","unggah Excel"),("is_current","bool","","")], "UK(project_id, item_id, version); stub di F1 (BR-PRJ-09, A-62)"),
        ...
        E("item_uom_conversions", "Konversi satuan khusus item", [("id","bigint","PK",""),("item_id","bigint","FK",""),("uom_id","bigint","FK","1 batang"),("qty_base","decimal(18,4)","","= 6 m"),("is_nominal_piece","bool","","hanya potongan nominal (BR-STK-09)"),("is_active","bool","","P-03: dilepas dari form = nonaktif, bukan dihapus")], "UK(item_id, uom_id)"),
        ...
        E("serials", "Serial / aset", [("id","bigint","PK",""),("item_id","bigint","FK",""),("serial_no","varchar(80)","",""),("asset_state","enum","","asset_state (BR-AST-01)"),("condition_grade","char(1)","",""),("lot_id","bigint","FK","opsional"),("expiry_date","date","",""),("rfid_tag","varchar(64)","","F2"),("current_project_id","bigint","FK","saat on_loan"),("due_return_date","date","",""),("acquired_at","date","","A-66"),("meter_unit","enum","","hour|km|none"),("meter_total","decimal(12,1)","","akumulasi"),("expected_life_days","int","",""),("expected_life_hours","decimal(12,1)","",""),("condition_score","tinyint","","0–100 % terakhir (BR-AST-08)")], "UK(item_id, serial_no); sisa umur % dihitung (BR-AST-08)"),
        ...
        E("company_settings", "Pengaturan company", [("key","varchar(60)","PK",""),("value","json","","")], "zona waktu, ambang toleransi default, kapasitas bin, konfirmasi terima otomatis (3 hari), stock_lock_date (BR-STK-15), reservation_alert_days (BR-STK-16), review_sla_days (BR-REQ-14), substitution_objection_days (BR-REQ-13), receipt_confirm_days (BR-REQ-10), asset_life_alert_pct (BR-AST-08), dll."),
...
dict(key="gudang", title="Gudang & lokasi (tenant)", file="08a",
     ...
     entities=[
        E("warehouse_types", "Tipe gudang", [("id","bigint","PK",""),("code","varchar(20)","UK","MAIN|BRANCH|SITE|…"),("name","varchar(60)","",""),("is_builtin","bool","",""),("is_active","bool","","")]),
        E("warehouses", "Gudang", [("id","bigint","PK",""),("code","varchar(10)","UK","segmen nomor dokumen"),("name","varchar(100)","",""),("warehouse_type_id","bigint","FK",""),("parent_id","bigint","FK","self, hierarki"),("project_id","bigint","FK","wajib bila type = site; satu proyek boleh punya beberapa (A-40)"),("head_user_id","bigint","FK","Kepala Gudang"),("address","text","",""),("is_active","bool","","")]),
        E("zones", "Zona", [("id","bigint","PK",""),("warehouse_id","bigint","FK",""),("code","varchar(10)","",""),("name","varchar(60)","",""),("is_active","bool","","")], "UK(warehouse_id, code)"),
        E("racks", "Rak", [("id","bigint","PK",""),("zone_id","bigint","FK",""),("code","varchar(10)","",""),("is_active","bool","","")], "UK(zone_id, code)"),
        E("rack_levels", "Level", [("id","bigint","PK",""),("rack_id","bigint","FK",""),("code","varchar(10)","",""),("is_active","bool","","")], "UK(rack_id, code)"),
        E("bins", "Bin", [("id","bigint","PK",""),("warehouse_id","bigint","FK","denormalisasi untuk query"),("rack_level_id","bigint","FK","null untuk bin virtual/dock"),("code","varchar(40)","UK","CKG-A-R03-L2-B05"),("bin_type","enum","","bin_type"),("bin_status","enum","","active|frozen|inactive"),("storage_category_id","bigint","FK",""),("capacity_qty","decimal(18,4)","",""),("capacity_weight","decimal(18,4)","",""),("capacity_volume","decimal(18,4)","",""),("capacity_length","decimal(18,4)","",""),("project_id","bigint","FK","hanya on_site"),("is_virtual","bool","",""),("frozen_by_count_id","bigint","FK","stock_counts"),("freeze_reason","varchar(255)","","alasan pembekuan"),("count_flag","bool","","perlu dihitung (A-67, BR-SJ-02)")]),
     ],
...
dict(key="stok", title="Stok: ledger, saldo, reservasi, kejadian (tenant)", file="08b",
     ...
     entities=[
        E("stock_movements", "Kartu stok (ledger)", [("id","bigint","PK",""),("item_id","bigint","FK",""),("from_bin_id","bigint","FK","null = masuk dari luar"),("to_bin_id","bigint","FK","null = keluar"),("lot_id","bigint","FK",""),("serial_id","bigint","FK",""),("piece_id","bigint","FK",""),("qty_base","decimal(18,4)","","selalu positif; arah dari from/to"),("stock_status","enum","","kondisi yang berpindah"),("project_id","bigint","FK",""),("document_type","varchar(30)","",""),("document_id","bigint","",""),("document_line_id","bigint","",""),("document_number","varchar(40)","","disalin agar riwayat terbaca tanpa join"),("reason_code_id","bigint","FK",""),("occurred_at","datetime","","UTC"),("performed_by","bigint","FK",""),("reverses_movement_id","bigint","FK","self; UK — satu baris hanya dibalik sekali"),("notes","varchar(255)","","")], "Tidak ada UPDATE/DELETE (trigger BEFORE UPDATE/DELETE + guard model). Index (item_id, to_bin_id), (document_type, document_id), (occurred_at)"),
        E("stock_balances", "Saldo stok", [("id","bigint","PK",""),("item_id","bigint","FK",""),("bin_id","bigint","FK",""),("lot_id","bigint","FK",""),("serial_id","bigint","FK",""),("piece_id","bigint","FK",""),("stock_status","enum","","available|quarantine|damaged"),("qty_base","decimal(18,4)","","≥ 0 (CHECK)"),("piece_count","int","","untuk piece"),("version","int","","optimistic lock cadangan")], "UK(item_id, bin_id, lot_key, serial_key, piece_key, stock_status) — tiga kolom turunan COALESCE(x,0) karena MySQL tidak membandingkan NULL; dikunci FOR UPDATE saat mutasi"),
        E("stock_reservations", "Reservasi", [("id","bigint","PK",""),("item_id","bigint","FK",""),("warehouse_id","bigint","FK","lunak"),("bin_id","bigint","FK","keras (nullable)"),("lot_id","bigint","FK",""),("serial_id","bigint","FK",""),("piece_id","bigint","FK",""),("qty_base","decimal(18,4)","",""),("level","enum","","soft|hard (BR-STK-04)"),("document_type","varchar(30)","","material_request|transfer"),("document_id","bigint","",""),("document_line_id","bigint","",""),("status","enum","","active|consumed|released"),("released_reason","varchar(60)","","BR-STK-05"),("released_at","datetime","","")], "Stok tersedia = Σ balance.available − Σ reservasi active (per item, gudang)"),
...
dict(key="outbound", title="Permintaan, picking, pengiriman, bukti terima, selisih (tenant)", file="08b",
     ...
     entities=[
        E("material_requests", "REQ header", [("id","bigint","PK",""),("number","varchar(40)","UK","REQ/<proyek>/<yymm>/<urut>"),("project_id","bigint","FK","A-22"),("requester_id","bigint","FK","users"),("requester_type","enum","","internal|client"),("required_date","date","","header default"),("reviewed_by","bigint","FK","Ditinjau Staf"),("reviewed_at","datetime","",""),("approval_snapshot_id","bigint","","tanpa FK sampai modul approval ada"),("approved_by","bigint","FK",""),("approved_at","datetime","",""),("closed_reason_id","bigint","FK","closed_short"),("cancel_reason_id","bigint","FK","cancelled"),("origin","enum","","request_origin: regular|supplement (A-54)"),("parent_request_id","bigint","FK","REQ induk bila supplement")], HDR_NOTE),
        E("material_request_lines", "REQ baris", [("id","bigint","PK",""),("material_request_id","bigint","FK",""),("item_id","bigint","FK","null bila non-katalog belum dipetakan"),("non_catalog_text","varchar(255)","","A-39"),("mapped_by","bigint","FK",""),("mapped_at","datetime","",""),("line_ownership","enum","","buy|loan (A-38)"),("required_date","date","",""),("source_warehouse_id","bigint","FK","A-31"),("fulfillment_source","enum","","stock|transfer|purchase (BR-REQ-05)"),("qty_base","decimal(18,4)","",""),("qty_reserved","decimal(18,4)","",""),("qty_shipped","decimal(18,4)","",""),("qty_received","decimal(18,4)","",""),("qty_backorder","decimal(18,4)","",""),("nominal_length","decimal(18,4)","","piece: 'n potongan ukuran nominal'"),("split_from_line_id","bigint","FK","self; pecah baris antar gudang (A-56)"),("promised_date","date","","tanggal janji (BR-REQ-14)"),("original_item_text","varchar(255)","","sebelum diganti (A-55)"),("substituted_at","datetime","",""),("substitution_deadline_at","datetime","",""),("substitution_response","enum","","accepted|rejected|expired"),("cancel_requested_at","datetime","","permintaan pembatalan klien (A-61)"),("cancel_reason_id","bigint","FK",""),("cancel_confirmed_by","bigint","FK",""),("cancel_confirmed_at","datetime","",""),("status","enum","","open|closed|cancelled — baris bisa dibatalkan sendiri")], LINE_NOTE),
        E("pick_tasks", "PCK header", [("id","bigint","PK",""),("number","varchar(40)","UK","PCK/<gudang>/<yymm>/<urut>"),("warehouse_id","bigint","FK",""),("assigned_to","bigint","FK",""),("started_at","datetime","",""),("completed_at","datetime","",""),("cancel_reason_id","bigint","FK","")], HDR_NOTE + "; source = material_request | transfer"),
        E("pick_task_lines", "PCK baris (alokasi keras)", [("id","bigint","PK",""),("pick_task_id","bigint","FK",""),("source_line_id","bigint","","baris REQ/TRF yang dipenuhi"),("item_id","bigint","FK",""),("bin_id","bigint","FK","alokasi"),("suggested_bin_id","bigint","FK",""),("qty_allocated","decimal(18,4)","",""),("qty_picked","decimal(18,4)","",""),("short_reason_id","bigint","FK","BR-SJ-02"),("override_reason","varchar(255)","","ganti saran"),("scanned_at","datetime","","")], LINE_NOTE),
        E("shipments", "SJ header", [("id","bigint","PK",""),("number","varchar(40)","UK","SJ/<gudang>/<yymm>/<urut>"),("warehouse_id","bigint","FK","asal"),("destination_type","enum","","project_client|site_warehouse|warehouse|vendor"),("destination_project_id","bigint","FK",""),("destination_warehouse_id","bigint","FK",""),("destination_vendor_id","bigint","FK","bila tujuan vendor"),("vehicle_id","bigint","FK",""),("driver_id","bigint","FK",""),("carrier_id","bigint","FK",""),("tracking_no","varchar(60)","",""),("shipment_method","enum","","own_fleet|carrier|self_delivered (A-57; self_delivered = transfer dalam proyek, A-50)"),("carried_by_name","varchar(100)","","bila self_delivered"),("loaded_at","datetime","","konfirmasi muat"),("shipped_at","datetime","",""),("delivered_at","datetime","","")], HDR_NOTE + "; BR-SJ-07"),
        ...
        E("proofs_of_delivery", "Bukti terima", [("id","bigint","PK",""),("shipment_id","bigint","FK","UK"),("received_by_name","varchar(100)","",""),("received_by_user_id","bigint","FK","nullable"),("signature_path","varchar(255)","","berkas di disk company (A-68)"),("photo_path","varchar(255)","",""),("lat","decimal(10,7)","",""),("lng","decimal(10,7)","",""),("confirmed_at","datetime","",""),("channel","enum","","driver_pwa|token_link"),("requester_confirmed_at","datetime","","BR-REQ-10"),("confirmation","enum","","receipt_confirmation: confirmed|disputed|auto_confirmed (A-63)"),("confirm_deadline_at","datetime","","confirmed_at + receipt_confirm_days"),("disputed_at","datetime","",""),("device_id","bigint","FK","")]),
        E("proof_of_delivery_lines", "Bukti terima baris", [("id","bigint","PK",""),("proof_of_delivery_id","bigint","FK",""),("shipment_line_id","bigint","FK",""),("qty_good","decimal(18,4)","",""),("qty_damaged","decimal(18,4)","","foto wajib bila > 0"),("qty_missing","decimal(18,4)","",""),("damage_photo_path","varchar(255)","","berkas di disk company (A-68)"),("notes","varchar(255)","","opsional")], "Per baris SJ (A-64); qty_good + qty_damaged + qty_missing = qty_shipped"),
        E("proof_of_delivery_units", "Bukti terima per unit", [("id","bigint","PK",""),("proof_of_delivery_line_id","bigint","FK",""),("serial_id","bigint","FK",""),("piece_id","bigint","FK",""),("condition","enum","","pod_unit_condition: good|damaged|missing")], "Hanya tracking_mode serial/piece (A-64); scan di PWA"),
        ...
        E("delivery_discrepancies", "DSC header", [("id","bigint","PK",""),("number","varchar(40)","UK","DSC/<gudang>/<yymm>/<urut>"),("shipment_id","bigint","FK",""),("origin","enum","","partial_delivery|client_dispute (A-63)"),("resolved_by","bigint","FK",""),("resolved_at","datetime","","")], HDR_NOTE),
        E("delivery_discrepancy_lines", "DSC baris", [("id","bigint","PK",""),("delivery_discrepancy_id","bigint","FK",""),("shipment_line_id","bigint","FK",""),("discrepancy_type","enum","","missing|damaged (A-64)"),("qty_base","decimal(18,4)","",""),("disposition","enum","","discrepancy_disposition (+reship)"),("client_decision","enum","","still_needed|not_needed"),("reason_code_id","bigint","FK",""),("claim_ref","varchar(60)","",""),("photo_path","varchar(255)","",""),("return_receipt_id","bigint","","GRN retur bila dibawa balik (A-65); tanpa FK sampai modul receipt ada")], LINE_NOTE + "; BR-SJ-10"),
     ],
     rels=[("projects","material_requests","1-n",""),("users","material_requests","1-n","pemohon"),("material_requests","material_request_lines","1-n",""),("items","material_request_lines","1-n",""),("warehouses","material_request_lines","1-n","sumber"),("material_requests","material_requests","1-n","REQ Tambahan"),("material_request_lines","material_request_lines","1-n","pecah baris"),("material_request_lines","pick_task_lines","1-n","source_line"),("pick_tasks","pick_task_lines","1-n",""),("bins","pick_task_lines","1-n",""),("pick_task_lines","shipment_lines","1-n",""),("shipments","shipment_lines","1-n",""),("warehouses","shipments","1-n","asal"),("vehicles","shipments","1-n",""),("carriers","shipments","1-n",""),("shipments","proofs_of_delivery","1-1",""),("proofs_of_delivery","proof_of_delivery_lines","1-n",""),("shipment_lines","proof_of_delivery_lines","1-n",""),("proof_of_delivery_lines","proof_of_delivery_units","1-n","serial/piece"),("shipments","delivery_tokens","1-n",""),("shipments","delivery_discrepancies","0-1",""),("delivery_discrepancies","delivery_discrepancy_lines","1-n",""),("shipment_lines","delivery_discrepancy_lines","1-n","")]),
...
dict(key="inbound", title="Penerimaan, put-away, retur ke vendor, PR, transfer, retur, pemakaian (tenant)", file="08b",
     ...
     entities=[
        ...
        E("purchase_requests", "PRQ header", [("id","bigint","PK",""),("warehouse_id","bigint","FK","tujuan"),("project_id","bigint","FK",""),("origin","enum","","purchase_request_origin: backorder|manual|reorder_point (BR-REQ-11)"),("submitted_by","bigint","FK",""),("forwarded_by","bigint","FK","Penindak Lanjut PR"),("forwarded_at","datetime","","")], HDR_NOTE + "; nomor memakai ALL (A-43); vendor/PO/ETA ada di catatan pemesanan (A-51)"),
        E("purchase_request_lines", "PRQ baris", [("id","bigint","PK",""),("purchase_request_id","bigint","FK",""),("material_request_line_id","bigint","FK","REQ penunggu"),("required_date","date","",""),("qty_base","decimal(18,4)","",""),("qty_ordered","decimal(18,4)","","Σ baris catatan pemesanan"),("qty_received","decimal(18,4)","","")], LINE_NOTE),
        E("purchase_request_orders", "Catatan pemesanan per vendor", [("id","bigint","PK",""),("purchase_request_id","bigint","FK",""),("vendor_id","bigint","FK","boleh provisional (A-53)"),("external_po_no","varchar(60)","","PO eksternal / PO Purchasing (F3)"),("marketplace_order_no","varchar(60)","","toko online"),("tracking_no","varchar(60)","","resi kurir"),("eta_date","date","",""),("ordered_by","bigint","FK","Penindak Lanjut PR"),("ordered_at","datetime","",""),("notes","varchar(255)","","opsional")], "Satu PRQ → n catatan (A-51); F3 diisi oleh kejadian po_created"),
        E("purchase_request_order_lines", "Baris catatan pemesanan", [("id","bigint","PK",""),("purchase_request_order_id","bigint","FK",""),("purchase_request_line_id","bigint","FK",""),("qty_ordered","decimal(18,4)","",""),("qty_received","decimal(18,4)","",""),("po_line_ref","varchar(60)","","F3")], "Satu baris PRQ boleh dipecah ke beberapa vendor (A-51)"),
     ...
     rels=[("warehouses","goods_receipts","1-n",""),("vendors","goods_receipts","1-n",""),("shipments","goods_receipts","0-1","transfer masuk"),("goods_returns","goods_receipts","0-1","retur masuk"),("goods_receipts","goods_receipt_lines","1-n",""),("purchase_request_order_lines","goods_receipt_lines","1-n","A-51"),("goods_receipts","putaway_tasks","1-n",""),("putaway_tasks","putaway_task_lines","1-n",""),("goods_receipt_lines","putaway_task_lines","1-n",""),("goods_receipts","vendor_returns","1-n",""),("vendor_returns","vendor_return_lines","1-n",""),("goods_receipt_lines","vendor_return_lines","1-n",""),("purchase_requests","purchase_request_lines","1-n",""),("material_request_lines","purchase_request_lines","1-n","backorder"),("purchase_requests","purchase_request_orders","1-n",""),("vendors","purchase_request_orders","1-n",""),("purchase_request_orders","purchase_request_order_lines","1-n",""),("purchase_request_lines","purchase_request_order_lines","1-n",""),("transfers","transfer_lines","1-n",""),("material_request_lines","transfer_lines","1-n","backorder"),("warehouses","transfers","1-n","asal/tujuan"),("projects","goods_returns","1-n",""),("shipments","goods_returns","1-n","asal"),("goods_returns","goods_return_lines","1-n",""),("shipment_lines","goods_return_lines","1-n",""),("pieces","goods_return_lines","1-n","offcut baru"),("projects","material_issues","1-n",""),("warehouses","material_issues","1-n","site"),("material_issues","material_issue_lines","1-n",""),("bins","material_issue_lines","1-n","")]),
...
dict(key="konversi-aset", title="Konversi, resep, waste, aset (tenant)", file="08c",
     ...
     entities=[
        ...
        E("asset_handovers", "AST serah terima", [("id","bigint","PK",""),("serial_id","bigint","FK",""),("project_id","bigint","FK",""),("shipment_line_id","bigint","FK","keluar"),("goods_return_line_id","bigint","FK","kembali"),("checked_out_at","datetime","",""),("due_return_date","date","",""),("condition_out","char(1)","",""),("photo_out_id","bigint","FK","attachments"),("returned_at","datetime","",""),("usage_days","int","","BR-AST-05"),("meter_out","decimal(12,1)","","A-66"),("meter_in","decimal(12,1)","","≥ meter_out (BR-AST-08)"),("usage_hours","decimal(12,1)","","meter_in − meter_out bila hour"),("status","enum","","checked_out|returned|inspected")], HDR_NOTE),
        E("asset_inspections", "Pemeriksaan aset", [("id","bigint","PK",""),("asset_handover_id","bigint","FK",""),("serial_id","bigint","FK",""),("inspected_by","bigint","FK",""),("inspected_at","datetime","",""),("condition_grade","char(1)","","A–D"),("condition_score","tinyint","","0–100 % wajib (BR-AST-08)"),("component_notes","json","","catatan per komponen"),("photo_id","bigint","FK",""),("notes","varchar(255)","",""),("resulting_state","enum","","available|maintenance|damaged")], "Riwayat kondisi aset (A-66)"),
...
dict(key="opname", title="Stock opname & penyesuaian (tenant)", file="08c",
     ...
     entities=[
        E("stock_counts", "OPN sesi", [("id","bigint","PK",""),("count_type","enum","","monthly|annual|adhoc|spot_check|cycle_abc (BR-OPN-10)"),("freeze_bins","bool","",""),("scope","json","","gudang/zona/bin/item"),("planned_start","date","",""),("started_at","datetime","",""),("approved_at","datetime","",""),("closed_at","datetime","",""),("report_attachment_id","bigint","FK","PDF"),("approval_snapshot_id","bigint","FK","")], HDR_NOTE + "; nomor memakai gudang atau ALL"),
...
dict(key="approval", title="Approval engine (tenant)", file="08c",
     ...
     entities=[
        E("approval_rules", "Aturan approval", [("id","bigint","PK",""),("document_type","varchar(30)","",""),("name","varchar(100)","",""),("priority","int","",""),("conditions","json","","gudang, proyek, kategori, kepemilikan, qty ≥, dari klien, jenis vendor, asal PRQ (BR-APR-07); F2: melebihi rencana"),("is_active","bool","","")]),
...
dict(key="umum", title="Timeline, audit, lampiran, notifikasi, template, penomoran, impor, sinkron (tenant)", file="08c",
     ...
     entities=[
        ...
        E("document_sequences", "Urutan nomor", [("id","bigint","PK",""),("document_type","varchar(30)","",""),("segment","varchar(20)","","kode gudang atau ALL"),("period","varchar(7)","","2026-09"),("last_number","int","","")], "UK(document_type, segment, period); SELECT … FOR UPDATE"),
