...
| Bukti bayar menunggu | Super Admin | belum — penghitung di beranda; penerima di database pusat ([A-237](04-keputusan-dan-asumsi.md#a-237)) |
...
1. Pengingat tagihan WA `[F2]` dan notifikasi bukti bayar ke Super Admin (email tagihan ke company sudah, A-202; ditunda [A-237](04-keputusan-dan-asumsi.md#a-237)).
