...
class ReferenceSeeder extends Seeder
{
    ...
    private const ROLES = [
        ...
        'internal_requester' => [
            ...
            'client' => false,
            'permissions' => ['auth.login', 'auth.logout', 'auth.two_factor', 'profile.update', 'device.manage', 'item.view', 'project.view', 'warehouse.view', 'stock.view', 'request.view', 'request.create', 'request.submit', 'request.cancel', 'request.close_short', 'request.confirm_receipt', 'request.dispute_receipt'],
        ],
        'pr_follow_up' => [
        ...
        'client_user' => [
            'name' => 'Klien',
            'client' => true,
            'permissions' => ['auth.login', 'auth.logout', 'profile.update', 'request.view', 'request.create', 'request.submit', 'request.cancel', 'request.add_lines', 'request.respond_substitution', 'request.request_cancel', 'request.confirm_receipt', 'request.dispute_receipt', 'shipment.view'],
        ],
    ];
