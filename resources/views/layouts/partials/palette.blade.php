...
@php
    $menu = collect([
        ...
        ['izin' => 'conversion.view', 'route' => 'conversions.index', 'label' => __('Konversi material'), 'ikon' => 'bi-scissors'],
        ['izin' => 'conversion.create', 'route' => 'conversions.create', 'label' => __('Konversi baru'), 'ikon' => 'bi-plus-square'],
        ['izin' => 'waste.view', 'route' => 'waste-disposals.index', 'label' => __('Berita acara waste'), 'ikon' => 'bi-trash3'],
        ['izin' => 'waste.create', 'route' => 'waste-disposals.create', 'label' => __('BA waste baru'), 'ikon' => 'bi-plus-square'],
        ['izin' => 'asset.view', 'route' => 'assets.index', 'label' => __('Aset'), 'ikon' => 'bi-truck-front'],
        ['izin' => 'asset.view', 'route' => 'asset-handovers.index', 'label' => __('Serah terima aset'), 'ikon' => 'bi-clipboard-check'],
        ['izin' => 'pr.view', 'route' => 'purchase-requests.index', 'label' => __('Purchase Request'), 'ikon' => 'bi-cart3'],
        ['izin' => 'pr.create', 'route' => 'purchase-requests.create', 'label' => __('PRQ manual'), 'ikon' => 'bi-plus-square'],
        ['izin' => 'po.view', 'route' => 'purchase-orders.index', 'label' => __('Purchase Order'), 'ikon' => 'bi-receipt-cutoff'],
        ['izin' => 'po.create', 'route' => 'purchase-orders.create', 'label' => __('PO baru'), 'ikon' => 'bi-plus-square'],
        ['izin' => 'vendor_price.view', 'route' => 'vendor-prices.index', 'label' => __('Harga beli vendor'), 'ikon' => 'bi-tags'],
        ...
        ['izin' => 'stock.lock_period', 'route' => 'stock.period', 'label' => __('Kunci periode'), 'ikon' => 'bi-calendar-check'],
        ...
        ['izin' => 'billing.view', 'route' => 'billing.index', 'label' => __('Tagihan langganan'), 'ikon' => 'bi-receipt'],
