...
@php
    $menu = collect([
        ...
        ['izin' => 'company_setting.manage', 'route' => 'setup.index', 'label' => __('Setup awal company'), 'ikon' => 'bi-rocket-takeoff'],
        ['izin' => 'item.create', 'route' => 'imports.index', 'label' => __('Impor data master dari Excel'), 'ikon' => 'bi-file-earmark-spreadsheet'],
