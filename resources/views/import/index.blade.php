...
@section('content')
    ...
    @foreach ([
        ...
        'bins' => ['judul' => __('Struktur gudang (zona, rak, level, bin)'), 'izin' => 'bin.manage', 'kolom' => $bins, 'catatan' => __('Satu baris = satu bin di gudang yang sudah ada. Zona, rak, dan level yang belum ada dibuat otomatis; yang sudah ada dipakai. Kode bin menjadi GUDANG-ZONA-RAK-LEVEL-BIN; kode yang sudah ada ditolak, tidak ditimpa. Jenis bin kosong = Penyimpanan (bin bawaan dan On-site dibuat otomatis). Kapasitas = jumlah maksimum; berat, volume, kategori penyimpanan, dan posisi denah diatur di layar.')],
    ] as $jenis => $d)
        @can($d['izin'])
