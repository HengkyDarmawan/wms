...
@section('content')
    ...
    <form method="POST" action="{{ route('platform.two-factor.store') }}" novalidate>
        @csrf
    ...
    <div class="text-center mt-4">
        <a class="nx-link small" href="{{ route('platform.login') }}">{{ __('Batal dan kembali ke halaman masuk') }}</a>
    </div>
@endsection
